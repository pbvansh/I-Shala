...
const Resume = () => {
    ...
    return (
        <section className="min-h-screen max-w-4xl mx-auto border p-10 m-5 rounded-md space-y-8">
            <p className="text-center font-semibold text-4xl p-5">Your Resume</p>
            <div>
                <div className="flex p-3 space-x-10">
                    <input defaultValue={resume?.Fname} onChange={(e) => setFName(e.target.value)} type={'text'} placeholder='First Name' className="shadow-md flex-1 rounded-sm p-2 focus:outline-none border focus:border-sky-500" />
                    <input defaultValue={resume?.Lname} onChange={(e) => setLName(e.target.value)} type={'text'} placeholder='Last Name' className="shadow-md flex-1 rounded-sm p-2 focus:outline-none border focus:border-sky-500" />
                </div>
                <div className="flex p-3 space-x-10">
                    <input defaultValue={resume?.email} onChange={(e) => setEmail(e.target.value)} type={'text'} placeholder='Email - xyz@gmail.com' className="shadow-md flex-1 rounded-sm p-2 focus:outline-none border focus:border-sky-500" />
                    <input defaultValue={resume?.contact} onChange={(e) => setContact(e.target.value)} type={'text'} placeholder='Mobile No.' className="shadow-md flex-1 rounded-sm p-2 focus:outline-none border focus:border-sky-500" />
                </div>
                <div className="flex p-3">
                    <textarea defaultValue={resume?.address} onChange={(e) => setAddress(e.target.value)} placeholder="Enter your address" className="shadow-md flex-1 focus:outline-none border focus:border-sky-500 p-2" />
                </div>
            </div>
            <hr />
            <div>
                <p className="text-2xl font-semibold text-sky-500">Graduation details</p>
                <div className="flex p-3 flex-col">
                    ...
                    }} type={'text'} placeholder='e.g. Hindu College' className="shadow-md flex-1 rounded-sm p-2 focus:outline-none border focus:border-sky-500" />
                </div>
                <div className="flex p-3 flex-col">
                    <label className="font-bold p-[5px] text-gray-700">Degree</label>
                    <input defaultValue={resume?.education?.degree} onChange={(e) => {
                        setEducation({ ...education, degree: e.target.value })
                    }} type={'text'} placeholder='e.g. B.Sc' className="shadow-md flex-1 rounded-sm p-2 focus:outline-none border focus:border-sky-500" />
                </div>
                <div className="flex p-3 space-x-5">
                    <div className="flex  flex-col flex-1 text-gray-700">
                        ...
                        }} type={'text'} placeholder='Choose Your' className="shadow-md flex-1 rounded-sm p-2 focus:outline-none border focus:border-sky-500" />
                    </div>
                    ...
                    <div className="flex flex-col flex-1">
                        ...
                        }} type={'text'} placeholder='0.00 (GP/10)' className="shadow-md flex-1 rounded-sm p-2 focus:outline-none border focus:border-sky-500" />
                    </div>
                </div>
            </div>
            <hr />
            <div>
                ...
                <div className="p-5">
                    <p onClick={() => setProjectModal(true)} className="flex items-center font-semibold hover:text-sky-500 cursor-pointer">
                        <PlusIcon className="h-5 px-1 font-semibold" /> Add academic/ personal project
                    </p>
                </div>
                {/* <div className="flex p-3 flex-col">
            ...
            <div>
                ...
                <div className="flex p-3 flex-col">
                    ...
                    <textarea defaultValue={resume?.skills} onChange={(e) => setSkills(e.target.value)} type={'text'} placeholder='e.g. C++,Java,PHP,etc...' className="shadow-md flex-1 rounded-sm p-2 focus:outline-none border focus:border-sky-500" />
                </div>
            </div>
            <hr />
            <div>
                ...
                <div className="flex p-3 flex-col">
                    <label className="font-semibold p-[5px] text-gray-700">Add Certificate</label>
                    <textarea defaultValue={resume?.certificate} onChange={(e) => setCertificate(e.target.value)} multiline={true} type={'text'} placeholder={'Put certificate link here like this \nABC,\nXYZ,\nETC...'} className="shadow-md flex-1 min-h-[120px] whitespace-pre-line rounded-sm p-2 focus:outline-none border focus:border-sky-500" />
                </div>
            </div>
            <hr />
            <div>
                ...
                <div className="flex p-3 flex-col">
                    <label className="font-semibold p-[5px] text-gray-700">Add work samples</label>
                    <textarea defaultValue={resume?.Portfolio_or_works} onChange={(e) => setPortfolio_or_works(e.target.value)} type={'text'} placeholder='e.g. C++,Java,PHP,etc...' className="shadow-md flex-1 rounded-sm p-2 focus:outline-none border focus:border-sky-500" />
                </div>
            </div>
            <hr />
            <div>
                <p className="text-2xl font-semibold text-sky-500">accomplishments/ additional details</p>
                <div>
                    {/* Your skills are here */}
                </div>
                <div className="flex p-3 flex-col">
                    <label className="font-semibold p-[5px] text-gray-700">Additional details</label>
                    <textarea defaultValue={resume?.Accomplishments} onChange={(e) => setAccomplishments(e.target.value)} type={'text'} placeholder='Write anything' className="shadow-md flex-1 rounded-sm p-2 focus:outline-none border focus:border-sky-500" />
                </div>
            </div>
            {
            ...
            <div className="flex justify-end">
                <button onClick={SaveResume} className="p-2 border rounded-md px-10 bg-sky-500 font-semibold hover:bg-sky-600  text-white shadow-md">Save Resume</button>
            </div>
        </section>
    )
}
